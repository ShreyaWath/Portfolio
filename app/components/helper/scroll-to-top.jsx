...
const ScrollToTop = () => {
  const [btnCls, setBtnCls] = useState(DEFAULT_BTN_CLS); // Ensure initial state matches SSR output
  const [isClient, setIsClient] = useState(false); // Track client-side rendering

  useEffect(() => {
    setIsClient(true); // Set client flag to true
  ...
  if (!isClient) return null; // Prevent rendering until client-side hydration
